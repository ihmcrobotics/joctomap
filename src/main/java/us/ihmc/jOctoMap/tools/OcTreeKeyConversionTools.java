...
public abstract class OcTreeKeyConversionTools
{
    ...
    */
   public static OcTreeKey coordinateToKey(Tuple3DReadOnly coord, double resolution, int treeDepth)
   {
    ...
    * @return key if point is within the octree (valid), null otherwise
    */
   public static boolean coordinateToKey(Tuple3DReadOnly coord, double resolution, int treeDepth, OcTreeKey keyToPack)
   {
    ...
    * @return key if point is within the octree (valid), null otherwise
    */
   public static OcTreeKey coordinateToKey(Tuple3DReadOnly coord, int depth, double resolution, int treeDepth)
   {
      return coordinateToKey(coord.getX(), coord.getY(), coord.getZ(), depth, resolution, treeDepth);
   }

   public static boolean coordinateToKey(Tuple3DReadOnly coord, int depth, double resolution, int treeDepth, OcTreeKey keyToPack)
   {
   ...
   public static void keyToCoordinate(OcTreeKeyReadOnly key, Tuple3DBasics coordinateToPack, double resolution, int treeDepth)
   {
